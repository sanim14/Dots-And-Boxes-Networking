        ...
        try
        {
            while(true)
            {
                        ...
                        && !gameData.isWinner('O') && !gameData.isCat())
                {
                    ...
                    System.out.println(cfc.getCommand());
                ...
                else if (cfc.getCommand() == CommandFromClient.RESTART)
                {
                    ...
                    {
                        gameData.reset();
                        o.writeObject(new CommandFromServer(CommandFromServer.RESTART, gameData + ""));
                    }

                    for (ObjectOutputStream o: outs)
                    {
                        o.writeObject(new CommandFromServer(CommandFromServer.X_TURN, gameData + ""));
                    }
